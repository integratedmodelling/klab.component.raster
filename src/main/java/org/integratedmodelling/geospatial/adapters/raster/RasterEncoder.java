...
//      RandomIter iterator, long[] xy, String mixingOperation, int nBands) {
...
//
//    var space = Scale.create(geometry).getSpace();
...
//            new int[] {0, 0}, new int[] {(int) space.shape()[0], (int) space.shape()[1]}, false);
//
